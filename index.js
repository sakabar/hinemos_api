...
sequelize.sync().then(() => {
    ...
    // lettersから3-styleを引く
    app.get(process.env.EXPRESS_ROOT + '/threeStyleFromLetters/:part', route.threeStyleFromLetters.getProcess);

    // あるユーザのナンバリングを取得
    // あるステッカーのナンバリングについて、全ユーザの分布を調べたりするためには、
    // 別のAPIが必要
    app.get(process.env.EXPRESS_ROOT + '/numbering/:part/:userName', route.numbering.getProcess);

    app.get(process.env.EXPRESS_ROOT + '/threeStyleQuizLog/:part/:userName', route.threeStyleQuizLog.getProcess);
    ...
    app.post(process.env.EXPRESS_ROOT + '/threeStyleQuizLog/:part', route.threeStyleQuizLog.postProcess);
    ...
    app.post(`${process.env.EXPRESS_ROOT}/getMemoLogStats`, route.memoLogStats.getProcess);
